        ...
        <div class="container">
            ...
            <div class="row">
                <div class="allEstablishments">
                    ...
                    <article v-if="item.userID === null || item.userID === ''">
                        <div class="info">
                            <div class="top">
                                <h3>{{ item.name }}</h3>
                                <div class="type">
                        ...
                        <router-link :to="'/edit/'+item.id" class="edit">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M17.2583 5.86484C17.5833 5.53984 17.5833 4.99818 17.2583 4.68984L15.3083 2.73984C15 2.41484 14.4583 2.41484 14.1333 2.73984L12.6 4.26484L15.725 7.38984M2.5 14.3732V17.4982H5.625L14.8417 8.27318L11.7167 5.14818L2.5 14.3732Z" fill="white"/>
                            </svg>
                        </router-link>
                    </article>
                    </template>
